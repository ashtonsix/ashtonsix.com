  ...
  return (
    <div>
      ...
      >
        I was inspired by{' '}
        <a
          href="https://www.instagram.com/drawingolive/"
          target="_blank"
          rel="noopener"
        >
          Olivia de Recat
        ...
        ’s artwork,{' '}
        <a
          href="https://kottke.org/19/01/closeness-lines-lovely-visualizations-of-relationships-over-time"
          target="_blank"
          rel="noopener"
        >
      ...
      >
        ...
        ,{' '}
        <a href="https://ashtonsix.com/resume" target="_blank" rel="noopener">
          resume
        </a>
        ,{' '}
        <a href="https://twitter.com/AshtonSix" target="_blank" rel="noopener">
          Twitter
        </a>{' '}
        and{' '}
      ...
      <p>
        <a
          href="https://www.linkedin.com/in/periwynkle/"
          target="_blank"
          rel="noopener"
        >
          Dr Yin Yin Lu
        ...
        and{' '}
        <a href="https://www.jongee.co.uk/" target="_blank" rel="noopener">
          Jon Gee
        </a>
        . Thank you both 😊
      </p>
